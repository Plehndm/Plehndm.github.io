...
- Interest-based event discovery with real-time notifications for matching events nearby
- Single codebase shipping to iOS, Android, and Web via React Native and Expo
